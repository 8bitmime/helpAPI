...
public class SipLayer implements SipListener {
	...
	//in theory: change the process message method in the other class to meet spec with
        // our ui.
	...
	setLastMsg(new String(req.getRawContent()));
	...
	try { //Reply with OK
	    ...
	    e.printStackTrace();
	    messageProcessor.processError("Can'sip send OK reply.");
	}
    }
    ...
    private void setLastMsg(String s){
        this.lastMsg = s;
    }
